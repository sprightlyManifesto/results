...
class createRace:
    ...
    def __init__(self):
        ...
        self.createButton = Button(
            self.root, text="Create", command=self.buttonCallback
        )  # button1.bind("<Button-1>",eCallback)
        ...
        self.checkAM = Checkbutton(
            self.root, text="AM", variable=self.AM, command=self.AMCallback
        )
        self.checkPM = Checkbutton(
            self.root, text="PM", variable=self.PM, command=self.PMCallback
        )
